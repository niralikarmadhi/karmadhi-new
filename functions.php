...
//       $bgcolorCls = 'light-mode';
//     }  else {
//       $bgcolorCls = '';
//     }

//   return array_merge($classes, array($bgcolorCls));
// });
...
// short code for add image in contact form 7
// function dynamic_image_shortcode() {
//   $image_url = get_template_directory_uri() . '/assets/images/file-upload.svg';
//   return '<img src="' . esc_url($image_url) . '" alt="File Upload">';
// }
