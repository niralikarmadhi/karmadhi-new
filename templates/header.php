    ...
    ?>
    <header class="dpt-30 dpb-30 header position-fixed w-100 top-0 tpt-20 tpb-20">
        <div class="container-large">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-6 nav-container d-lg-flex d-none">
                ...
                <div class="col-lg-3 text-end d-lg-flex d-none">
                ...
                <div class="col-4 d-lg-none d-flex justify-content-end">
                    <div class="menu-icon cursor-pointer">
                        <img src="/wp-content/uploads/2025/03/menu.png" alt="menu-icon" class="h-100 object-fit-contain menu-bar">
                        <img src="/wp-content/uploads/2025/03/close.png" alt="menu-icon" class="h-100 object-fit-contain close-bar">
                    </div>
                </div>
            </div>
            <div class="logo--bg mobile-header transition px-2">
                <nav class="header-container pt-2">
                    <?php if (!empty($nav_links)): ?>
                        <ul class="header-menu w-fit mb-0 p-0 list-none">
                            <?php foreach ($nav_links as $nav_link) : ?>
                                <?php if (!empty($nav_link['sub_link'])): ?>
                                    <?php if (!empty($nav_link['link']['url'])): ?>
                                        <li class="menu-link sub-menu-link">
                                            <a href="<?php echo $nav_link['link']['url'] ?>" class="text-decoration-none text--color font20 urbanist leading1_2 d-flex">
                                                <?php echo $nav_link['link']['title'] ?>
                                                <span class="sub-arrow">
                                                    <img src="<?= get_template_directory_uri(); ?>/assets/images/down-arrow.svg" alt="" class="h-100 w-100 object-fit-contain" />
